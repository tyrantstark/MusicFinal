<template>
  <div class="message-section">
    ...
    <div class="messages">
      <h2
        v-if="$route.name === 'Message' && getConversations.length != 0"
        class="messages_heading"
      >
        Click on a user to open a conversation
      </h2>
      <h2 v-else-if="$route.name === 'Message'" class="messages_heading">
        Go to someone's profile and send a message!
      </h2>
