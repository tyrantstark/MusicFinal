...
router.get('/message/:id/file', async (req,res) => {
    try {
...
router.post('/message/file', auth, upload.single('upload'), async (req,res) => {
...
router.get('/message/conversation/:id', auth, async (req,res) => {
