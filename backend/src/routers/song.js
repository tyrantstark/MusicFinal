...
router.post('/song', auth, uploadSong.single('upload'), async (req,res) => {
...
router.post('/song/:id/image', upload2.single('upload'), async (req,res) => {
...
router.get('/song/me', auth, async (req,res) => {
...
router.get('/song/profile/:id',async (req,res) => {
    try {
...
router.get('/song/:id/songFile', async (req,res) => {
    try {
        const song = await Song.findById(req.params.id)
        if(!song) {
           return res.status(404).send()
...
router.get('/song/:id/image', async (req,res) => {
